...
### 7. Maintenance: Update the Index
**CRITICAL:** When you create a new tool, you MUST add it to `agents/commands/TOOL_INDEX.md`.
- Find the correct Domain section
- Add a row to the table: `| Tool Name | One-line Description | Key Use Case |`
